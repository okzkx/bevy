...
对应 [学习目标实现步骤.md](../学习目标实现步骤.md) 步骤 2，本文件夹存放该步的全部产出。主产出（`宿主壳搭建记录.md`）与 README 留根，其余专题文档在 [材料/](材料/)。（编号约定（2026-09-22）：本步四项施工①~④ = **2.1~2.4**，见[路线图·编号约定](../学习目标实现步骤.md)；下文保留历史编号原文）
...
- 《[宿主壳搭建记录.md](宿主壳搭建记录.md)》——主产出（2026-09-21 **收官重写为终态总结**：一句话总结/终态架构（模块分层+宿主桥编排+关键决策表）/四项施工精要/合并坑表/证据汇总/步骤 3 接口；逐施工原始记录在 git 历史。**2026-09-22 步骤 3 开工结构整理**：三系统自 main.rs 迁入 `host.rs` 宿主桥，main 只做插件组装——编排内容不变，见搭建记录 §1）
