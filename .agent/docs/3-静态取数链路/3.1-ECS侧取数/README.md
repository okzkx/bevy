...
**状态：✅ 已完成（2026-09-22）——3.1.1~3.1.4 全部收官；ECS 侧"数据看得见"落地，GPU 半边自施工 3.2 起步。段级收官总结见[《3.1-ECS侧取数总结》](3.1-ECS侧取数总结.md)**
...
- **《[3.1-ECS侧取数总结.md](3.1-ECS侧取数总结.md)》——段级收官总结（2026-09-23）**：终态数据链与模块落点、四任务精要、合并坑表、段内定案（快照拓扑契约 / 解耦成组 / WorldAsset 术语 / 同帧 relay）、实测证据汇总、给 3.2 的接口
